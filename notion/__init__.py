...
load_dotenv()
env_api_key = os.getenv("NOTION_API_KEY", "")


@dlt.resource
def notion_pages(
    page_ids: Optional[List[str]] = None, api_key: str = env_api_key
) -> Iterator[TDataItems]:
    """
...
def notion_databases(
    database_ids: Optional[List[Dict[str, str]]] = None, api_key: str = env_api_key
